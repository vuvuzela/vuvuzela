...
func init() {
	...
	proto.RegisterType((*CloseRoundResponse)(nil), "convopb.CloseRoundResponse")
...
func (m *RoundSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ServiceData) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintMixnet(dAtA, i, uint64(len(m.ServiceData)))
...
func (m *CloseRoundResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintMixnet(dAtA, i, uint64(len(m.Result)))
...
func (m *RoundSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.ServiceData = append(m.ServiceData[:0], dAtA[iNdEx:postIndex]...)
...
var fileDescriptorMixnet = []byte{
	...
	,
}
